...
You can create a subscription by calling the subscriptions endpoint and in the Request body passing proper JSON.  Below is an example of that the JSON shoujld look like.
~~~
{
   "changeType": "created",
